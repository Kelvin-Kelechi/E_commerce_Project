...
import { addToCart, filterbySize } from "../../redux/actions";
const Shops = (props) => {
  const cartItems = useSelector((state) => state.cart.cartItems);
  const dispatch = useDispatch();
  const handleCheck = (e) => {
    dispatch(filterbySize(props.products, e.target.value));
  };
  return (
    <>
          ...
          <div className="col-lg-9 col-md-8">
            <div className="row pb-3">
              ...
              {cartItems && cartItems && cartItems.map((items) => (
                <div key={items.id} className="col-lg-4 col-md-6 col-sm-6 pb-1">
