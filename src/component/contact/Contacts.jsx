        ...
        <div className="row px-xl-5">
            <div className="col-lg-7 mb-5">
                <div className="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form   action='https://getform.io/f/d3f4df75-a839-4533-988c-e5b3f0984b37' method='POST'  >
            ...
            <div className="col-lg-5 mb-5">
                <div className="bg-light p-30 mb-30">
                    <iframe style={{width: 100, height: 250, border:0}}
                ...
                <div className="bg-light p-30 mb-3">
                    ...
                    <p className="mb-2"><i className="fa fa-envelope text-primary mr-3"></i>kelexkelly336@gmail.com</p>
                    <p className="mb-2"><i className="fa fa-phone-alt text-primary mr-3"></i>+2349130680659</p>
                </div>
            </div>
        </div>
    </div></>
